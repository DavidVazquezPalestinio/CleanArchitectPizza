...
public class BlazingPizzaRepository : IBlazingPizzaRepository
{
    ...
    public async Task<IReadOnlyCollection<BusinessObjects.Entities.PizzaSpecial>> GetSpecialsAsync()
    {
    ...
    public async Task<IReadOnlyCollection<BusinessObjects.Entities.Topping>> GetToppingsAsync()
    {
